export function Logo() {
  return (
    ...
    >
      <path
        fill="url(#paint0_linear_36060_89)"
      ...
      ></path>
      <path
        fill="url(#paint1_linear_36060_89)"
      ...
      ></path>
      <path
        fill="url(#paint2_linear_36060_89)"
      ...
      ></path>
      <path
        fill="url(#paint3_linear_36060_89)"
        d="M70.822 15.21c.399 0 .72.156.962.468.26.312.39.72.39 1.222 0 .693-.338 1.222-1.014 1.586-.589.295-1.291.546-2.106.754a9.548 9.548 0 01-2.21.286c-1.421 0-2.66-.269-3.718-.806a5.732 5.732 0 01-2.444-2.314c-.572-1.005-.858-2.184-.858-3.536 0-1.283.269-2.427.806-3.432.555-1.023 1.318-1.811 2.288-2.366.988-.572 2.098-.858 3.328-.858 1.196 0 2.245.26 3.146.78a5.23 5.23 0 012.08 2.21c.503.953.754 2.071.754 3.354 0 .399-.095.71-.286.936-.173.208-.433.312-.78.312h-6.864c.122.832.39 1.43.806 1.794.416.364 1.032.546 1.846.546a5.16 5.16 0 001.196-.13 14.7 14.7 0 001.222-.416c.26-.104.512-.19.754-.26.26-.087.494-.13.702-.13zm-4.446-5.876c-.606 0-1.092.2-1.456.598-.364.381-.58.945-.65 1.69h4.082c-.104-1.525-.762-2.288-1.976-2.288z"
      ></path>
      <path
        fill="url(#paint4_linear_36060_89)"
        d="M82.942 6.214c1.526 0 2.661.46 3.406 1.378.746.901 1.118 2.28 1.118 4.134v5.616c0 .659-.208 1.179-.624 1.56-.416.381-.979.572-1.69.572-.71 0-1.274-.19-1.69-.572-.416-.381-.624-.901-.624-1.56v-5.408c0-.763-.138-1.317-.416-1.664-.26-.347-.658-.52-1.196-.52-.693 0-1.248.225-1.664.676-.398.433-.598 1.023-.598 1.768v5.148c0 .659-.208 1.179-.624 1.56-.416.381-.979.572-1.69.572-.71 0-1.274-.19-1.69-.572-.416-.381-.624-.901-.624-1.56V8.346c0-.607.217-1.1.65-1.482.434-.399.997-.598 1.69-.598.66 0 1.18.182 1.56.546.4.364.598.84.598 1.43a4.435 4.435 0 011.742-1.508c.711-.347 1.5-.52 2.366-.52z"
      ></path>
      <path
        fill="url(#paint5_linear_36060_89)"
        d="M99.777 15.912c1.386 0 2.08.563 2.08 1.69 0 1.144-.694 1.716-2.08 1.716h-8.19c-.607 0-1.101-.19-1.482-.572a1.878 1.878 0 01-.572-1.378c0-.572.216-1.1.65-1.586l5.46-5.85h-4.186c-1.387 0-2.08-.572-2.08-1.716 0-1.127.693-1.69 2.08-1.69h7.878c.606 0 1.1.19 1.482.572.381.381.572.84.572 1.378 0 .555-.217 1.075-.65 1.56l-5.486 5.876h4.524z"
      ></path>
      <path
        fill="url(#paint6_linear_36060_89)"
      ...
      ></path>
      <path
        fill="url(#paint7_linear_36060_89)"
        d="M121.274 15.21c.398 0 .719.156.962.468.26.312.39.72.39 1.222 0 .693-.338 1.222-1.014 1.586-.59.295-1.292.546-2.106.754a9.552 9.552 0 01-2.21.286c-1.422 0-2.661-.269-3.718-.806a5.729 5.729 0 01-2.444-2.314c-.572-1.005-.858-2.184-.858-3.536 0-1.283.268-2.427.806-3.432.554-1.023 1.317-1.811 2.288-2.366.988-.572 2.097-.858 3.328-.858 1.196 0 2.244.26 3.146.78a5.236 5.236 0 012.08 2.21c.502.953.754 2.071.754 3.354 0 .399-.096.71-.286.936-.174.208-.434.312-.78.312h-6.864c.121.832.39 1.43.806 1.794.416.364 1.031.546 1.846.546.433 0 .832-.043 1.196-.13.364-.104.771-.243 1.222-.416.26-.104.511-.19.754-.26.26-.087.494-.13.702-.13zm-4.446-5.876c-.607 0-1.092.2-1.456.598-.364.381-.581.945-.65 1.69h4.082c-.104-1.525-.763-2.288-1.976-2.288z"
      ></path>
      <defs>
        <linearGradient
          id="paint0_linear_36060_89"
          x1="35.386"
          x2="35.886"
          y1="19.318"
          y2="19.318"
        ...
        >
          <stop stopColor="#FD377E"></stop>
          <stop offset="1" stopColor="#212529"></stop>
        </linearGradient>
        <linearGradient
          id="paint1_linear_36060_89"
          x1="35.386"
          x2="35.886"
          y1="19.318"
          y2="19.318"
